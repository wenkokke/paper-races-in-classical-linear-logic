...
\begin{definition}[Reduction]\label{def:hcp-reduction}
  ...
  \begin{gather*}
    \begin{array}{llcll}
      \hcpRedAxCut1
      & \tm{\piNew{x}{(\piPar{\cpLink{w}{x}}{P})}}
      & \Longrightarrow
      & \tm{\cpSub{w}{x}{P}}
      \\
      \hcpRedBetaTensParr
      & \tm{\piNew{x}{(\piPar{\piSend{x}{y}{P}}{\piRecv{x}{y}{R}})}}
      & \Longrightarrow
      & \tm{\piNew{x}{\piNew{y}{(\piPar{P}{R})}}}
      \\
      \hcpRedBetaOneBot
      & \tm{\piNew{x}{(\piPar{\piSend{x}{}{P}}{\piRecv{x}{}{Q}})}}
      & \Longrightarrow
      & \tm{\piPar{P}{Q}}
      \\
      \hcpRedBetaPlusWith1
      & \tm{\piNew{x}{(\piPar{\cpInl{x}{P}}{\cpCase{x}{Q}{R}})}}
      & \Longrightarrow
      & \tm{\piNew{x}{(\piPar{P}{Q})}}
      \\
      \hcpRedBetaPlusWith2
      & \tm{\piNew{x}{(\piPar{\cpInr{x}{P}}{\cpCase{x}{Q}{R}})}}
      & \Longrightarrow
      & \tm{\piNew{x}{(\piPar{P}{R})}}
    \end{array}
  \end{gather*}
...
\begin{prooftree}
  ...
  \BIC{$\seq[{ (\piPar{\cpSend{y}{x}{\ami}{\boe}}{\cpRecv{y}{x}{\store}}) }]{
      ...
      \Theta, \tmty{y}{\cake \parr \cake} }$}
  \NOM{Cut}
  \UIC{$\seq[{ \piNew{y}{(\piPar{\cpSend{y}{x}{\ami}{\boe}}{\cpRecv{y}{x}{\store}})} }]{
      \Gamma, \Delta, \Theta }$}
\end{prooftree}
...
\[%
  ...
  \begin{array}{lrlrl}
    \nu x.&((  & \; \ncCnt{x}{y}{\cpInl{y}{\cpHalt{y}}} \\
          ...
          &    & \quad
                 \begin{array}{rl}
                   \{ & \texttt{inl}: \; \piNew{w}{(\piPar{\cpCase{z}{\cpWait{z}{\cpHalt{w}}}{
                           \cpWait{z}{\cpHalt{w}}}}{\cpWait{w}{P}})}
                   \\
                    ; & \texttt{inr}: \; \piNew{w}{(\piPar{\cpCase{z}{\cpWait{z}{\cpHalt{w}}}{
