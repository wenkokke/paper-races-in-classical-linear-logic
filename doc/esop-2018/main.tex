...
choice.\footnote{%
  This operator is written as \tm{P+Q}, but should not be confused with
...
\citenat{paykin2016}; and, inspired by \citenat{lindley2015semantics}, we
...
\end{theorem}
\begin{proof}
  As \cref{thm:cp-termination}, extended with the reductions and equivalences in
  \cref{fig:nc-preservation,fig:cp-preservation-equiv}.
  \qed
\end{proof}
