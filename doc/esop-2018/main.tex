...
\end{center}
\wen{%
  Write about local choice introducing non-determinism explicitly, as opposed to
  the \textpi-calculus, which introduces it implicitly through shared channels.
}
