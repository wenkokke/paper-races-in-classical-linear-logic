...
\begin{abstract}
  ...
  \dhcp is a reformulation of \cp which addresses a fundamental shortcoming: the fact that the fundamental operator for parallel composition from the \textpi-calculus does not correspond to any rule of linear logic, and therefore not to any term construct in \cp.
...
In this section, we introduce \dhcp~\parencite{kokke2018tlla,kokke2019pacmpl}, the basis for our calculus \nodcap. \dhcp is a reformulation of \cp which addresses a fundamental shortcoming: the fact that the fundamental operator for parallel composition from the \textpi-calculus does not correspond to any rule of linear logic, and therefore not to any term construct in \cp.
