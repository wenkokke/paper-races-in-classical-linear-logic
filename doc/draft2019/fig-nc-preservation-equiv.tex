  ...
  \begin{tabular}{ll}
    ...
    &
      \begin{prooftree*}
        ...
        \AXC{$\seq[{ Q }]{ \Delta, \tmty{x}{\take[l]{A}}, \tmty{y}{\take[m]{B}} }$}
        \NOM{Pool}
        \BIC{$\seq[{ \ncPool{P}{Q} }]{ \Gamma, \Delta, \tmty{x}{\take[k+l]{A}}, \tmty{y}{\take[m]{B}} }$}
        \AXC{$\seq[{ R }]{ \Theta, \tmty{x}{\take[n]{B}} }$}
        \NOM{Pool}
        \BIC{$\seq[{ \ncPool{\ncPool{P}{Q}}{R} }]{ \Gamma, \Delta, \Theta, \tmty{x}{\take[k+l]{A}}, \tmty{y}{\take[m+n]{B}} }$}
      \end{prooftree*}
    \\[20pt]
    \ncRedKappaPool1
    &
    ...
    &
      \begin{prooftree*}
        ...
        \AXC{$\seq[{ Q }]{ \Delta, \tmty{x}{A}, \tmty{y}{\take[n]{B}} }$}
        \NOM{Pool}
        \BIC{$\seq[{ \ncPool{P}{Q} }]{ \Gamma, \Delta, \tmty{x}{A}, \tmty{y}{\take[m+n]{B}} }$}
        \AXC{$\seq[{ R }]{ \Theta, \tmty{x}{A^\bot} }$}
        \NOM{Cut}
