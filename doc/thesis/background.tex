...
congruence defined by \citenat{wadler2012} does not include \cpEquivLinkComm.
...
\citenat{wadler2012} has two reduction rules which deal with links. The first of
