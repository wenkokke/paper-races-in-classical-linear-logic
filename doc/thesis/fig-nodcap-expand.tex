...
\begin{figure*}
  ...
  \begin{tabular}{ccc}
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{x}{x_1}\give{\send{x}{y}}P }]
        { \Gamma, \tm[x_1]{A} }$}
    \end{proofbox}
    &$\Longrightarrow$&
    \begin{proofbox}
    ...
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{x}{x_1 \cdots x_{m+n}}\subst{P}{x}{y} }]
    ...
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{x}{x_1 \cdots x_m}P }]
        { \Gamma, \tm[x_1]{A}\cdots\tm[x_m], \tm[y]{\give[n]{A}} }$}
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{y}{x_{m+1} \cdots x_{m+n}}\expand{x}{x_1 \cdots x_m}P }]
        { \Gamma, \tm[x_1]{A}\cdots\tm[x_{m+n}]{A} }$}
    \end{proofbox}
  \end{tabular}
  
  \caption{Principal expansions for \nodcap}
  \label{fig:nodcap-expand-principal}
\end{figure*}
...
\begin{figure*}
  \begin{tabular}{ccc}
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{x}{x_1 \cdots x_n}\wait{y}P }]
    ...
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{x_1 \cdots x_n}{x}P }]
        { \Gamma, \tm[x_1]{A}\cdots\tm[x_n]{A}, \Delta }$}
      \SYM{\bot}
      \UIC{$
        \seq[{ \wait{y}\expand{x}{x_1 \cdots x_n}P }]
        { \Gamma, \tm[x_1]{A}\cdots\tm[x_n]{A}, \Delta, \tm[y]{\bot} }$}
    \end{proofbox}
    \\\\
    (no case for \one)
    ...
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[\expand{x}{x_1\cdots x_n}\case{y}{}{}]
    ...
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{x}{x_1 \cdots x_n}\recv{z}{y}P }]
    ...
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{x}{x_1 \cdots x_n}P }]
        { \Gamma, \tm[x_1]{A}\cdots\tm[x_n]{A}, \Delta, \tm[y]{B}, \tm[z]{C} }$}
      \SYM{\parr}
      \UIC{$
        \seq[{ \recv{z}{y}\expand{x}{x_1 \cdots x_n}P }]
        { \Gamma, \tm[x_1]{A}\cdots\tm[x_n]{A}, \Delta, \tm[z]{B \parr C} }$}
    \end{proofbox}
    \\\\
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{x}{x_1 \cdots x_n}\send{z}{y}(P \mid Q) }]
    ...
    \begin{proofbox}
      ...
      \SYM{\tens}
      \BIC{$
        \seq[{ \send{z}{y}(\expand{x}{x_1 \cdots x_n}P \mid Q) }]
        { \Gamma, \tm[x_1]{A}\cdots\tm[x_2]{A}, \Delta, \Theta, \tm[z]{A \tens B} }$}
    \end{proofbox}
%   \\\\
%   \begin{proofbox}
...
%     \NOM{Exp}
%     \UIC{$
%       \seq[{ \expand{x}{x_1 \cdots x_n}Q }]
%       { \Delta, \tm[x_1]{A}\cdots\tm[x_2]{A}, \Theta, \tm[z]{C} }$}
%     \SYM{\tens}
%     \BIC{$
%       \seq[{ \send{z}{y}(P \mid \expand{x}{x_1 \cdots x_n}Q) }]
%       { \Gamma, \Delta, \tm[x_1]{A}\cdots\tm[x_2]{A}, \Theta, \tm[z]{B \tens C} }$}
%   \end{proofbox}
    \\\\
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{x}{x_1 \cdots x_n}\case{y}{P}{Q} }]
    ...
    \begin{proofbox}
      ...
      \SYM{\with}
      \BIC{$
        \seq[{ \case{y}{\expand{x}{x_1 \cdots x_n}P}{\expand{x}{x_1 \cdots x_n}Q} }]
        { \Gamma, \tm[x_1]{A}\cdots\tm[x_n]{A}, \Delta, \tm[y]{B \with C} } $}
    \end{proofbox}
    }
    \\\\
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{x}{x_1 \cdots x_n}\inl{y}P }]
    ...
    \begin{proofbox}
      ...
      \SYM{\plus_1}
      \UIC{$
        \seq[{ \inl{y}\expand{x}{x_1 \cdots x_n}P }]
        { \Gamma, \tm[x_1]{A}\cdots\tm[x_n]{A}, \Delta, \tm[y]{B \plus C} }$} 
    \end{proofbox}
%   \\\\
%   \begin{proofbox}
...
%   \end{proofbox}                    
    ...
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{x}{x_1 \cdots x_n}\give{\send{z}{y}}P }]
    ...
    \begin{proofbox}
      ...
      \SYM{\give[1]{}}
      \UIC{$
        \seq[{ \give{\send{z}{y}}\expand{x}{x_1 \cdots x_n}P }]
        { \Gamma, \tm[x_1]{A}\cdots\tm[x_n]{A}, \Delta, \tm[z]{\give[1]{B}} }$}
    \end{proofbox}
    \\\\
%   \begin{proofbox}
...
%   \end{proofbox}
    ...
    \begin{proofbox}
      ...
      \NOM{Cont}
      \UIC{$
        \seq[{ \expand{x}{x_1 \cdots x_n}\subst{P}{y}{z} }]
        { \Gamma, \tm[x_1]{A}\cdots\tm[x_n]{A}, \Delta, \tm[y]{\give[p+q]{B}} }$}
    \end{proofbox}
    \\\\
    \begin{proofbox}
      ...
      \NOM{Exp}
      \UIC{$
        \seq[{ \expand{x}{x_1 \cdots x_n}(P \mid Q) }]
...
%     \NOM{Pool}
%     \BIC{$
%       \seq[{ (P \mid \expand{x}{x_1 \cdots x_n}Q) }]
%       { \Gamma, \Delta, \tm[x_1]{A}\cdots\tm[x_2]{A}, \Theta, \tm[y]{\take[p+q]{B}} }$}
%   \end{proofbox}
  \end{tabular}

  \caption{Permutation expansions for \nodcap}
  \label{fig:nodcap-expand-permutation}
\end{figure*}
\restoregeometry