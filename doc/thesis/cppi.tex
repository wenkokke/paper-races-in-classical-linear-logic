...
\wen{Mention the other differences, e.g.\ case instead of input-guarded choice,
  name restriction and parallel composition as a single construct, etc.}
...
\citenat{lindley2015semantics}, but drops the suffix of commutative
conversions.
...
\wen{
  Say something about how I'm making explicit the implicit motivation of
  \citeauthor{lindley2015semantics}.
}
...
\citenat{wadler2012}, we apply a commutative conversion. 
\begin{align*}
  \begin{array}{lll}
    \tm{\cpCut{x}{\cpCut{y}{
    \cpRecv{x}{z}{\cpRecv{y}{w}{\alice}}}{
...
\wen{%
  Explain that CP \emph{barely} uses its structural congruence in its reduction strategy.}
