...
\begin{abstract}
  ...
  bounded linear logic~\cite{girard1992}, which allows non-determinism, and as
...
CP~\cite{wadler2012}, inspired by bounded linear logic~\cite{girard1992}, which
allows non-determinism, and as such permits programs with races, without losing
the tight correspondence with classical linear logic or the guarantee of
deadlock. 
...
$\pi$-calculus~\cite{milner1992a,milner1992b}. Processes in RCP are defined by
...
Mary, respectively.
As shown in~\cite{atkey2016}, such a program becomes typable in a version of CP
...
choice~\cite{milner1992a,milner1992b}. Though there are differences between the
...
structural recursion, based on work on fixed points in linear
logic~\cite{baelde2007}. 
